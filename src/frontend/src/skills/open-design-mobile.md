...
MoneyDrive is a mobile-first Progressive Web App (PWA). When designing screens:
- Use the burnt orange/gold/navy SA dark theme palette
- Bottom tab bar: Dashboard, eTavern, Nduna, Earnings, More
- SA-localized copy: "Hola 7!" greeting, "Molo" for Xhosa users, "Sawubona" for Zulu contexts
- Nduna chat screen: F — Focus archetype, large voice button, SA township energy
- In-car sales screen: E — Checkout archetype, SnapScan QR prominent
- Earnings screen: A — Feed archetype with trip cards showing daily totals

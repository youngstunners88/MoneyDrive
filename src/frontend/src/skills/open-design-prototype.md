...
Use this skill for quick MoneyDrive marketing mock-ups, driver-facing landing pages, or pilot onboarding flows.

**Section rhythm for MoneyDrive landing**:
1. Hero (dark navy, large display type, burnt orange CTA)
2. Features grid (6 tiles, burnt orange icons)
3. Testimonials (3 SA driver quotes)
4. Pilot mode banner ("Free for 90 days — no credit card")
5. CTA footer (gold accent band)

**Brand language constraints**:
- Greeting: "Hola 7!" (not "Hello Driver")
- Community: "eTavern" (not "Forum")
- AI agent: "Nduna" (always male, SA-local persona, never "chatbot" or "assistant")
- Platform: "MoneyDrive" (never "app" without context)

**Typography for SA audience**: Use high-contrast, large body text. Many drivers read on phone screens in direct sunlight. Minimum 16px body, 18px recommended.

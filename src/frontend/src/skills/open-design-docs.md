...
When building documentation for MoneyDrive (driver manual, API docs, Nduna integration guide):

**Left nav groups**:
1. Getting Started — Sign Up, Verify Account, Choose Tier, First Login
2. Nduna AI — Chat, Voice, Pitch Decks, Campaign Engine
3. Earnings Tools — Trip Tracker, Expense Log, Fleet Dashboard
4. In-Car Retail — SnapScan Setup, Product Menu, Sales Reports
5. Payments — SnapScan, MiniPay, Subscription Tiers
6. Admin — Pilot Mode, API Keys, Analytics, eTavern Moderation

**Code blocks**: Use SA example data (e.g., Rand amounts, SA phone number format +27...)

**Callout types**:
- Note (gold border): Tips for SA driving conditions
- Warning (burnt orange border): Important financial warnings
- Pilot (navy border): Features restricted in pilot mode

**Manual source**: Pull content from https://github.com/youngstunners88/MoneyDrive-Manual when available. Render inline, never redirect to raw PDF.

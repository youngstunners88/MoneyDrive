...
MoneyDrive has a 3-tier subscription model in ZAR (South African Rand):

| Tier | Name | Normal Price | Pilot Price | Target Driver |
|------|------|-------------|-------------|---------------|
| 1 | Starter | R350/mo | **R0.00** (pilot) | New / occasional drivers |
| 2 | Growth | R530/mo | **R0.00** (pilot) | Regular drivers, fleet ≤5 |
| 3 | Pro | R800/mo | R800/mo | Power drivers, fleet owners |

**Pilot mode copy** (when `pilotMode === true`): "Free 90-day pilot — no card required. We'll ask for feedback in exchange."

**Recommended tier**: Tier 2 (Growth) — highlight with burnt orange border.

**Payment**: SnapScan QR code (not Stripe). CTA = "Subscribe with SnapScan".

**Tier 1 features**: Dashboard, Smart Scheduling, Fuel Intelligence, In-Car Retail (QR), Expense Tracking, Nduna Chat, Referrals.

**Tier 2 adds**: Fleet Dashboard (≤5 vehicles), Advanced Analytics, Priority Nduna, eTavern access.

**Tier 3 adds**: Advertising Broker, Website Builder, Hyperframes Video, Campaign Engine, Lead Scraping, API Access.
